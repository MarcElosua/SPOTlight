...
sce_9cells_qc@assays$data$counts
library(Matrix)

# spot_counts <- Matrix(sce_9cells_qc@assays$data$counts,sparse = T)
#############################################################################################
##### Make sure Rownames spot matrix are the same as the ones used to train the model! ######
#############################################################################################
SpatialDeconTest::spot_deconvolution(lda_mod = lda_mod, se_obj = se_sc_10x_5cl_qc, 
