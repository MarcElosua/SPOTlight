...
brain_st <- readRDS(sprintf("../spatial_deconvolution/analysis/mouse_brain/2019-11-26/R_objects_2019-11-26/brain1_processed.RDS"))
anterior <- brain_st[, brain_st$slice == "Anterior"]
```

```{r eval = FALSE, echo = FALSE}
anterior <- Seurat::SCTransform(anterior, assay = "Spatial")
...
saveRDS(object = anterior,
        file = "sample_data/brain_anterior_ST_processed.RDS")
```
