...
If we take a look at cell cycle genes to see if we need to correct by it we see that the cells are pretty synchronized, G2 signature is present but ince it is better to not over-correct the data we won"t regress out the cell cycle.
```{r eval = FALSE}
