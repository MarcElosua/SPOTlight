...
Lastly, if we want to visualize the topic by which each cell identity is made out of we can do the following.
...
The above plot gives a lot of information since it gives a sesne of how good we will be able to differentiate certain clusters, 2 clusters with very similar topic profile composition will tend to be harder to discern between them.
