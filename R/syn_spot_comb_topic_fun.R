...
syn_spot_comb_topic <- function(lda_mod, se_obj, clust_vr, verbose = T){
  ...
  clust_profiles <- topic_profile_per_cluster(lda_mod = lda_mod_best, se_obj = se_obj, clust_vr = 'seurat_clusters')
